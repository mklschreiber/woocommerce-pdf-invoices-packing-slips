...
if ( !class_exists( '\\WPO\\WC\\PDF_Invoices\\Documents\\Deposit_Invoice' ) ) :

/**
 * Invoice Document
 * 
 * @class       \WPO\WC\PDF_Invoices\Documents\Deposit_Invoice
 * @version     2.0
 * @category    Class
 * @author      Michael Schreiber
 */

class Deposit_Invoice extends Order_Document_Methods {
	/**
	...
	public function __construct( $order = 0 ) {
		// set properties
		$this->type		= 'deposit_invoice';
		$this->title	= __( 'Deposit Invoice', 'woocommerce-pdf-invoices-packing-slips' );
	...
	public function get_title() {
		...
		return apply_filters( "wpo_wcpdf_{$this->slug}_title", __( 'Deposit Invoice', 'woocommerce-pdf-invoices-packing-slips' ), $this );
	}
	...
	public function get_settings() {
		...
		$document_settings = get_option( 'wpo_wcpdf_documents_settings_deposit_invoice' );
	...
	public function init_settings() {
		// Register settings.
		$page = $option_group = $option_name = 'wpo_wcpdf_documents_settings_deposit_invoice';
		...
		$settings_fields = array(
			...
			array(
				...
				'args'			=> array(
					'option_name'	=> $option_name,
					'id'			=> 'deposit_invoice_number_column',
				)
			),
			array(
				'type'			=> 'setting',
